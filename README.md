...
![High-level architecture: Teams / M365 Copilot, Production and Development bot identities, APIM (validate-jwt), Orchestrator Agent / Local agent, AI Search and Microsoft Foundry](./docs/architecture-overview.png)

<!-- Diagram source: docs/architecture-overview.mmd (regenerate the PNG with mermaid-cli) -->
...
The architecture diagrams are authored as Mermaid sources in `docs/*.mmd` and rendered to PNG with [`@mermaid-js/mermaid-cli`](https://github.com/mermaid-js/mermaid-cli).
